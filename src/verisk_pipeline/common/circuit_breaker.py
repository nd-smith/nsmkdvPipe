...
from verisk_pipeline.common.observability import MetricsCollector
...
class CircuitBreaker:
    ...
    def __init__(
        ...
        # Metrics collector for observability (Task G.2)
    ...
    def _transition_to(self, new_state: CircuitState) -> None:
        ...
        # Export state transition counter metric (Task G.2)
    ...
    def _record_success(self) -> None:
        ...
        # Export success counter metric (Task G.2)
        self._metrics.increment_counter(
    ...
    def _record_failure(self, exc: Exception) -> None:
        ...
        # Export failure counter metric (Task G.2)
        self._metrics.increment_counter(
            "circuit_breaker_calls_total",
    ...
    def _export_state_metric(self) -> None:
        """Export current circuit state as metric (Task G.2)."""
