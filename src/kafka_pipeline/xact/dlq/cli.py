"""
Command-line interface for xact domain DLQ message management.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DLQ message management CLI for xact domain",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # List all DLQ messages
  python -m kafka_pipeline.xact.dlq.cli list

  # List with custom limit
  python -m kafka_pipeline.xact.dlq.cli list --limit 50

  # View specific message
  python -m kafka_pipeline.xact.dlq.cli view evt-123

  # Replay message to pending topic
  python -m kafka_pipeline.xact.dlq.cli replay evt-123

  # Mark message as resolved
  python -m kafka_pipeline.xact.dlq.cli resolve evt-123
        """,
    )
