...
Usage:
    ...
    python -m kafka_pipeline.claimx.dlq.cli inspect enrichment --limit 5
    ...
    python -m kafka_pipeline.claimx.dlq.cli replay enrichment --event-ids evt_123,evt_456

    # Replay all messages from download DLQ
    python -m kafka_pipeline.claimx.dlq.cli replay download --all
    ...
    python -m kafka_pipeline.claimx.dlq.cli purge download --yes
"""
        ...
        try:
            ...
            async for record in consumer:
                ...
                try:
                    ...
                    logger.error(f"Failed to parse message at offset {record.offset}: {e}")
                    continue
...
Examples:
    ...
    python -m kafka_pipeline.claimx.dlq.cli replay download --event-ids media_123,media_456
