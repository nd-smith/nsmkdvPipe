"""
Delta batch retry scheduler for ClaimX.
...
class DeltaBatchRetryScheduler:
    """
    Scheduler for retrying failed ClaimX Delta batch writes.
    ...
    Usage:
        ...
        ...     config=config,
        ...     producer=producer,
        ...     table_path="abfss://workspace@onelake/lakehouse/Tables/claimx_events"
        ... )
    ...
    def __init__(
        ...
        logger.info(
            "Initialized ClaimX DeltaBatchRetryScheduler",
            extra={
    ...
    async def start(self) -> None:
        ...
        logger.info(
            "Starting ClaimX DeltaBatchRetryScheduler",
    ...
    async def stop(self) -> None:
        ...
        logger.info(
            "Stopping ClaimX DeltaBatchRetryScheduler",
            extra={
        ...
        logger.info("ClaimX DeltaBatchRetryScheduler stopped successfully")
    ...
    async def _handle_retry_message(self, message: ConsumerRecord) -> None:
        ...
        try:
            success = await self.delta_writer.write_events(failed_batch.events)
