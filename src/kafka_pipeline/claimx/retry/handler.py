...
class DeltaRetryHandler:
    ...
    def __init__(
        ...
        retry_topic_prefix: str = "claimx-delta-events.retry",
        dlq_topic: str = "claimx-delta-events.dlq",
        domain: str = "claimx",
    ):
        """
        ...
        Args:
            ...
            domain: Domain identifier for metrics (default: "claimx")
        """
        self.config = config
    ...
    def get_retry_topic(self, retry_count: int) -> str:
        ...
        Returns:
            Topic name like "claimx-delta-events.retry.5m"
        """
