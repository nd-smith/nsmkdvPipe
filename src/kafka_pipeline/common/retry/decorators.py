                ...
                try:
                    ...
                    if (
                        ...
                        log_with_context(
                            logger,
                            logging.INFO,
                            "Auth error detected, refreshing credentials",
                            operation=func.__name__,
