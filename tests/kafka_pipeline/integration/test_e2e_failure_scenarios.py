    ...
    with patch("core.download.downloader.AttachmentDownloader.download") as mock_download:
        ...
        try:
            ...
            task = DownloadTaskMessage(
                ...
                destination_path="test/circuit-test-001/file.pdf",
                event_type="claim",
    ...
    with patch("core.download.downloader.AttachmentDownloader.download") as mock_download:
        ...
        try:
            ...
            task = DownloadTaskMessage(
                ...
                destination_path="test/auth-test-001/secure-file.pdf",
                event_type="claim",
                event_subtype="created",
                retry_count=0,
                original_timestamp=datetime.now(timezone.utc),
    ...
    with patch("core.download.downloader.AttachmentDownloader.download") as mock_download:
        ...
        try:
            ...
            task = DownloadTaskMessage(
                ...
                destination_path="test/onelake-retry-001/document.pdf",
                event_type="claim",
                event_subtype="created",
                retry_count=0,
                original_timestamp=datetime.now(timezone.utc),
    ...
    with patch("core.download.downloader.AttachmentDownloader.download") as mock_download:
        ...
        try:
            ...
            task = DownloadTaskMessage(
                ...
                destination_path=f"test/{test_event.trace_id}/large_document.pdf",
